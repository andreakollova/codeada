...
function generateBots(): LeaderboardEntry[] {
  const names = [
    ...
    'Rain','Sol','Trix','Vega','Wolf','Aero','Blaze','Raven','Orion','Phoenix',
    'Ash','Birch','Cedar','Dove','Elm','Flint','Grove','Hawk','Indie','Juniper',
    'Kobe','Leaf','Maple','North','Opal','Pine','Reef','Storm','Timber','Vista',
    'Aspen','Brook','Cliff','Delta','Ember','Frost','Gale','Heath','Isle','Jet',
    'Kelp','Lake','Moss','Neve','Oak','Peak','Quill','Reed','Sage','Tide',
    'Vale','Wave','Yarrow','Zenith','Amber','Bliss','Cloud','Dawn','Eden','Fable',
    'Gem','Haven','Ink','Joy','Karma','Light','Muse','Nest','Orb','Plum',
    'Quest','Rune','Silk','Thyme','Unity','Vine','Willow','Wish','Zephyr','Aura',
    'Bloom','Coral','Drift','Fawn','Glow','Honey','Ivory','Jewel','Kiwi','Lotus',
    'Meadow','Nectar','Olive','Petal','Rose','Saffron','Terra','Violet','Wisteria','Azul',
    'Breeze','Celeste','Dusk','Flora','Halo','Indigo','Jasper','Koi','Lark','Mica',
    'Nimbus','Oasis','Prism','Ripple','Shade','Thorn','Umber','Wisp','Xenon','Yew',
    'Zinc','Basil','Chai','Dune','Echo2','Fjord','Garnet','Heron','Ion','Jade2',
    'Kestrel','Lapis','Mirage','Noon','Obsidian','Pearl','Quartz','Rook','Slate','Talon',
    'Urchin','Vortex','Wraith','Xylem','Yonder','Zodiac','Aegis','Bolt','Cipher','Dash',
    'Elixir','Forge','Glitch','Hex','Icon','Jazz','Knot','Link','Myth','Node',
    'Opus','Proxy','Quirk','Root','Spark2','Token','Unix','Vector','Warp','Xor',
    'Yaml','Zero','Alloy','Binary','Cache','Debug','Event','Flag','Grid','Hash',
    'Index','Json','Key','Loop','Merge','Null','Orbit','Parse','Query','Render',
    'Stack','Thread','Upload','Void','Widget','Xpath','Yield','Zip','Alpha','Beta',
    'Gamma','Delta2','Sigma','Omega','Theta','Kappa','Zeta','Eta','Iota','Mu',
    'Rho','Tau','Phi','Chi','Psi','Nu','Xi','Pi','Lambda','Epsilon',
  ];
