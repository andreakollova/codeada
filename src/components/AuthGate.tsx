        ...
        <AnimatePresence mode="wait">
          {step === 'start' && (
            <motion.div key="start" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              ...
              {/* Google - only on web, blocked in native WebView */}
              ...
              {/* Email button - primary in app, secondary on web */}
              <button
                onClick={() => setStep('email')}
                style={{
                  width: '100%', padding: '14px', borderRadius: 12,
                  background: typeof window !== 'undefined' && (window as any).Capacitor ? '#fff' : '#161616',
                  color: typeof window !== 'undefined' && (window as any).Capacitor ? '#000' : '#ccc',
                  fontWeight: typeof window !== 'undefined' && (window as any).Capacitor ? 700 : 600,
                  fontSize: 14,
                  border: typeof window !== 'undefined' && (window as any).Capacitor ? 'none' : '1px solid #222',
