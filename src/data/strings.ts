...
const strings = {
  ...
  // NameModal
  heyImByte: { en: "Hey, I'm Byte", sk: 'Ahoj, ja som Byte' },
  illTeachYou: { en: "I'll teach you how to code. But first — what's your name?", sk: 'Naučím ťa programovať. Ale najprv — ako sa voláš?' },
